...
ColumnsDescription StorageSystemProcesses::getColumnsDescription()
{
    ...
    auto description = ColumnsDescription
    {
        ...
        {"http_method", std::make_shared<DataTypeUInt8>(), "HTTP method that initiated the query. Possible values: 0 - The query was launched from the TCP interface, 1 - GET method was used, 2 - POST method was used, 4 - PUT method was used, 5 - DELETE method was used, 6 - HEAD method was used, 7 - QUERY method was used."},
