...
- using the POST or QUERY method.
- Send the beginning of the query in the 'query' parameter, and the rest using POST or QUERY
...
Requests using GET and QUERY are 'readonly'. This means that for queries that modify data, you can only use the POST method. 
